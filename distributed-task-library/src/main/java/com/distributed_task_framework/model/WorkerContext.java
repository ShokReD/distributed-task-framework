...
public class WorkerContext {
    ...
    @Builder.Default
    List<LocalCommand> localCommands = new ArrayList<>();
    @Builder.Default
    List<RemoteCommandEntity> remoteCommandsToSend = new ArrayList<>();
    @Builder.Default
    Map<UUID, JoinTaskMessage<Object>> taskMessagesToSave = new HashMap<>();
    @Builder.Default
    Set<UUID> dropJoinTasksIds = new HashSet<>();
