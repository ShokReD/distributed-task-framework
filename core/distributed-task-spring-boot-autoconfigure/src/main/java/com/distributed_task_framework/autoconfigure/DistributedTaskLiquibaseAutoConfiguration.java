...
public class DistributedTaskLiquibaseAutoConfiguration {
    ...
    public ActualLiquibaseMigrationsChecker actualLiquibaseMigrationsChecker(ApplicationContext applicationContext) {
        return new ActualLiquibaseMigrationsChecker(applicationContext);
    }
